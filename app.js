...
const GAME_LIBRARY = [
  {
    ...
    problems: [
      ...
      {
        type: "도형 배열을 수로 나타내기",
        text: "쌓기나무가 1번째 4개, 2번째 7개, 3번째 10개입니다. 4번째는?",
        answer: "13개",
        options: ["12개", "13개", "14개", "16개"],
        rule: "차례가 하나 늘 때마다 3개씩 증가합니다."
      },
      {
        type: "도형 배열을 수로 나타내기",
        text: "타일 무늬가 1번째 5개, 2번째 10개, 3번째 15개입니다. 5번째는?",
        answer: "25개",
        options: ["20개", "24개", "25개", "30개"],
        rule: "차례가 하나 늘 때마다 타일이 5개씩 늘어납니다."
      },
      {
        type: "도형 배열을 수로 나타내기",
        text: "창문이 1줄에 3개씩 늘어납니다. 2줄 6개, 3줄 9개라면 6줄은?",
        answer: "18개",
        options: ["15개", "16개", "18개", "21개"],
        rule: "줄 수에 3을 곱하면 창문 수가 됩니다."
      },
      {
        type: "도형 배열을 수로 나타내기",
        text: "블록 탑이 1번째 6개, 2번째 9개, 3번째 12개입니다. 6번째는?",
        answer: "21개",
        options: ["18개", "20개", "21개", "24개"],
        rule: "6에서 시작해 3개씩 늘어납니다."
      },
      {
        type: "규칙을 식으로 나타내기",
        text: "1번째 2, 2번째 6, 3번째 10, 4번째 14입니다. 6번째 수는?",
        answer: "22",
        options: ["18", "20", "22", "24"],
        rule: "처음 2에서 4씩 커지는 규칙입니다."
      },
      {
        type: "규칙을 식으로 나타내기",
        text: "1번째 7, 2번째 12, 3번째 17입니다. 5번째 수는?",
        answer: "27",
        options: ["22", "25", "27", "32"],
        rule: "5씩 커지는 규칙이므로 7, 12, 17, 22, 27입니다."
      },
      {
        type: "규칙을 식으로 나타내기",
        text: "1번째 3, 2번째 8, 3번째 13, 4번째 18입니다. 7번째는?",
        answer: "33",
        options: ["28", "31", "33", "38"],
        rule: "3에서 시작해 5씩 커지는 규칙입니다."
      },
      {
        type: "규칙을 식으로 나타내기",
        text: "어떤 수에 4를 곱하고 1을 더합니다. 들어간 수가 6이면 나온 수는?",
        answer: "25",
        options: ["21", "24", "25", "28"],
        rule: "6×4+1=25입니다."
      },
      {
        type: "수 배열표에서 규칙 찾기",
        text: "수 배열표에서 오른쪽으로 6씩 커집니다. 18, 24, 30, □",
        answer: "36",
        options: ["32", "34", "36", "42"],
        rule: "오른쪽으로 한 칸 갈 때마다 6을 더합니다."
      },
      {
        type: "수 배열표에서 규칙 찾기",
        text: "수 배열표에서 오른쪽으로 8씩 커집니다. 11, 19, 27, □",
        answer: "35",
        options: ["33", "34", "35", "37"],
        rule: "8씩 더하는 규칙입니다."
      },
      {
        type: "수 배열표에서 규칙 찾기",
        text: "수 배열표에서 아래로 한 칸 내려가면 20씩 커집니다. 34 아래의 수는?",
        answer: "54",
        options: ["44", "50", "54", "64"],
        rule: "아래로 한 칸 내려가면 20이 커집니다."
      },
      {
        type: "수 배열표에서 규칙 찾기",
        text: "수 배열표에서 위로 한 칸 올라가면 10씩 작아집니다. 73 위의 수는?",
        answer: "63",
        options: ["53", "62", "63", "83"],
        rule: "위로 한 칸 올라가면 10을 뺍니다."
      },
      {
        type: "수 배열표에서 규칙 찾기",
        text: "수 배열표에서 대각선 아래 오른쪽으로 갈 때 11씩 커집니다. 22 다음은?",
        answer: "33",
        options: ["31", "32", "33", "44"],
        rule: "아래로 10, 오른쪽으로 1이 함께 움직여 11이 커집니다."
      },
      {
        type: "등호의 의미",
        text: "양쪽의 값이 같은 식을 고르세요.",
        answer: "9+8 = 20-3",
        options: ["9+8 = 20-3", "6+7 = 15-1", "12-4 = 5+4", "8+6 = 20-4"],
        rule: "9+8과 20-3은 모두 17입니다."
      },
      {
        type: "등호의 의미",
        text: "□에 들어갈 수는? 18 + 7 = □ + 10",
        answer: "15",
        options: ["13", "14", "15", "17"],
        rule: "18+7은 25이고, 15+10도 25입니다."
      },
      {
        type: "등호의 의미",
        text: "□에 들어갈 수는? 30 - □ = 12 + 5",
        answer: "13",
        options: ["11", "12", "13", "17"],
        rule: "12+5는 17이고, 30-13도 17입니다."
      },
      {
        type: "등호의 의미",
        text: "등호가 바르게 쓰인 식을 고르세요.",
        answer: "16-7 = 3+6",
        options: ["16-7 = 3+6", "14-5 = 2+8", "9+6 = 20-3", "18-4 = 9+6"],
        rule: "16-7과 3+6은 모두 9입니다."
      },
      {
        type: "등호의 의미",
        text: "□에 들어갈 수는? 7×4 = □ + 8",
        answer: "20",
        options: ["18", "19", "20", "22"],
        rule: "7×4는 28이고, 20+8도 28입니다."
      },
      {
        type: "덧셈식 배열에서 규칙 찾기",
        text: "11+2=13, 12+4=16, 13+6=19, 다음 식의 값은?",
        answer: "22",
        options: ["20", "21", "22", "24"],
        rule: "첫째 수는 1씩, 둘째 수는 2씩 커져서 합은 3씩 커집니다."
      },
      {
        type: "덧셈식 배열에서 규칙 찾기",
        text: "5+9=14, 7+10=17, 9+11=20, 다음 값은?",
        answer: "23",
        options: ["21", "22", "23", "25"],
        rule: "첫째 수는 2씩, 둘째 수는 1씩 커져서 합은 3씩 커집니다."
      },
      {
        type: "덧셈식 배열에서 규칙 찾기",
        text: "20+1=21, 18+4=22, 16+7=23, 다음 값은?",
        answer: "24",
        options: ["22", "23", "24", "26"],
        rule: "앞 수는 2씩 작아지고 뒤 수는 3씩 커져 합은 1씩 커집니다."
      },
      {
        type: "뺄셈식 배열에서 규칙 찾기",
        text: "40-5=35, 40-8=32, 40-11=29, 다음 값은?",
        answer: "26",
        options: ["24", "25", "26", "27"],
        rule: "빼는 수가 3씩 커져서 결과는 3씩 작아집니다."
      },
      {
        type: "뺄셈식 배열에서 규칙 찾기",
        text: "60-10=50, 55-10=45, 50-10=40, 다음 값은?",
        answer: "35",
        options: ["30", "35", "40", "45"],
        rule: "처음 수가 5씩 작아져 결과도 5씩 작아집니다."
      },
      {
        type: "뺄셈식 배열에서 규칙 찾기",
        text: "35-2=33, 35-6=29, 35-10=25, 다음 값은?",
        answer: "21",
        options: ["19", "20", "21", "23"],
        rule: "빼는 수가 4씩 커져서 결과는 4씩 작아집니다."
      },
      {
        type: "곱셈식 배열에서 규칙 찾기",
        text: "6×2=12, 6×3=18, 6×4=24, 6×5=?",
        answer: "30",
        options: ["28", "30", "32", "36"],
        rule: "곱하는 수가 1씩 커지면 값은 6씩 커집니다."
      },
      {
        type: "곱셈식 배열에서 규칙 찾기",
        text: "3×5=15, 4×5=20, 5×5=25, 다음 값은?",
        answer: "30",
        options: ["25", "28", "30", "35"],
        rule: "앞의 수가 1씩 커져 곱은 5씩 커집니다."
      },
      {
        type: "곱셈식 배열에서 규칙 찾기",
        text: "9×1=9, 9×2=18, 9×3=27, 다음 값은?",
        answer: "36",
        options: ["30", "34", "36", "45"],
        rule: "9씩 커지는 곱셈식 배열입니다."
      },
      {
        type: "나눗셈식 배열에서 규칙 찾기",
        text: "48÷6=8, 42÷6=7, 36÷6=6, 다음 값은?",
        answer: "5",
        options: ["4", "5", "6", "7"],
        rule: "나누어지는 수가 6씩 작아져 몫은 1씩 작아집니다."
      },
      {
        type: "나눗셈식 배열에서 규칙 찾기",
        text: "72÷8=9, 64÷8=8, 56÷8=7, 다음 값은?",
        answer: "6",
        options: ["5", "6", "7", "8"],
        rule: "나누어지는 수가 8씩 작아져 몫은 1씩 작아집니다."
      },
      {
        type: "나눗셈식 배열에서 규칙 찾기",
        text: "45÷5=9, 40÷5=8, 35÷5=7, 다음 값은?",
        answer: "6",
        options: ["5", "6", "7", "8"],
        rule: "나누어지는 수가 5씩 작아져 몫은 1씩 작아집니다."
      },
      {
        type: "규칙적인 계산식 만들기",
        text: "달력에서 오른쪽으로 하루씩 갑니다. 23, 24, 25 다음 수는?",
        answer: "26",
        options: ["24", "25", "26", "30"],
        rule: "달력에서 오른쪽으로 한 칸 가면 1이 커집니다."
      },
      {
        type: "규칙적인 계산식 만들기",
        text: "버스 좌석 번호가 2, 4, 6, 8, □ 순서입니다. 다음 번호는?",
        answer: "10",
        options: ["9", "10", "12", "16"],
        rule: "2씩 커지는 짝수 배열입니다."
      },
      {
        type: "규칙적인 계산식 만들기",
        text: "운동장 표지판이 15m, 30m, 45m, □ 순서입니다. 다음은?",
        answer: "60m",
        options: ["50m", "55m", "60m", "75m"],
        rule: "15m씩 커지는 거리 표시입니다."
      },
      {
        type: "규칙적인 계산식 만들기",
        text: "사물함 번호가 101, 104, 107, 110 순서입니다. 다음 번호는?",
        answer: "113",
        options: ["111", "112", "113", "114"],
        rule: "3씩 커지는 번호 배열입니다."
      },
      {
        type: "규칙적인 계산식 만들기",
        text: "계단 번호가 50, 45, 40, 35 순서입니다. 다음 수는?",
        answer: "30",
        options: ["25", "30", "32", "40"],
        rule: "5씩 작아지는 규칙입니다."
      },
      {
        type: "수 카드 규칙 설명하기",
        text: "수 카드 9, 18, 27, 36 다음에 알맞은 카드는?",
        answer: "45",
        options: ["42", "45", "48", "54"],
        rule: "9씩 커지는 규칙입니다."
      },
      {
        type: "수 카드 규칙 설명하기",
        text: "수 카드 50, 46, 42, 38 다음에 알맞은 카드는?",
        answer: "34",
        options: ["30", "32", "34", "36"],
        rule: "4씩 작아지는 규칙입니다."
      },
      {
        type: "수 카드 규칙 설명하기",
        text: "수 카드 4, 12, 20, 28 다음에 알맞은 카드는?",
        answer: "36",
        options: ["32", "34", "36", "40"],
        rule: "8씩 커지는 규칙입니다."
      },
      {
        type: "수 카드 규칙 설명하기",
        text: "수 카드 1, 3, 7, 15 다음에 알맞은 카드는?",
        answer: "31",
        options: ["23", "27", "31", "35"],
        rule: "앞의 수에 2를 곱한 뒤 1을 더합니다."
      },
      {
        type: "수 카드 규칙 설명하기",
        text: "수 카드 80, 40, 20, 10 다음에 알맞은 카드는?",
        answer: "5",
        options: ["2", "4", "5", "8"],
        rule: "앞의 수를 2로 나누는 규칙입니다."
      },
      {
        type: "빈칸 찾기",
        text: "□, 14, 21, 28, 35에서 □에 알맞은 수는?",
        answer: "7",
        options: ["5", "6", "7", "8"],
        rule: "7씩 커지는 규칙이므로 처음 수는 7입니다."
      },
      {
        type: "빈칸 찾기",
        text: "12, □, 24, 30, 36에서 □에 알맞은 수는?",
        answer: "18",
        options: ["16", "18", "20", "22"],
        rule: "6씩 커지는 규칙입니다."
      },
      ...
      },
      {
        ...
        answer: "23",
        options: ["21", "22", "23", "24"],
        rule: "3을 더하고 4를 더하는 규칙이 반복됩니다."
      },
      {
        type: "두 규칙 반복",
        text: "10, 20, 18, 28, 26, 36, □",
        answer: "34",
        options: ["32", "34", "38", "46"],
        rule: "10을 더하고 2를 빼는 규칙이 반복됩니다."
      },
      {
        type: "두 규칙 반복",
        text: "1, 2, 4, 5, 10, 11, □",
